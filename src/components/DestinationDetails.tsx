...
const DestinationDetails = () => {
  ...
  return (
    <div className="bg-dark-1 py-[2rem] px-[3rem] max-h-[80%] overflow-scroll overflow-x-hidden rounded-xl w-full flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-[18px] font-medium capitalize text-light-1">
          {cityName}
        </span>
      </div>
      <div className="flex flex-col gap-1">
        <span className="font-medium text-[14px] text-light-2 uppercase">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Link
          ...
          className="text-[18px] font-medium capitalize text-secondary"
        >
